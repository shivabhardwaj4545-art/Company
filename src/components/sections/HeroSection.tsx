...
export function HeroSection({ onOpenModal }: HeroSectionProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-10 right-0 w-96 h-96 bg-[#a3e635]/15 rounded-full blur-3xl pointer-events-none" />

      <div className="relative z-10 max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          
          {/* ========================================================================= */}
          {/* LEFT COLUMN: TITLE, SUBTITLE, EMAIL FORM, CONSENT (Image 1 SS)            */}
          {/* ========================================================================= */}
          <div className="lg:col-span-6 space-y-6">
            
            {/* Top Pill Badge matching Proprietary Tech green badge color */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#18181B] text-[#a3e635] border border-[#a3e635]/40 text-xs font-black uppercase tracking-widest shadow-sm">
              <Sparkles className="w-3.5 h-3.5 text-[#a3e635]" />
              INTELLIGENT DIGITAL STUDIO
            </div>

            {/* Main Headline Matching Image 1 SS */}
            <h1 className="text-3xl sm:text-5xl lg:text-[54px] xl:text-[60px] font-black font-display text-[var(--text-primary)] leading-[1.04] tracking-tight uppercase">
              THE <span className="text-[#a3e635]">INTELLIGENT</span> FINANCIAL &amp; WEB PLATFORM FOR <span className="text-[#a3e635]">GLOBAL</span> BUSINESSES
            </h1>
            ...
            <div className="pt-1">
              <a
                href="#services"
                data-cursor="hover"
                className="inline-flex items-center gap-1.5 text-xs font-black uppercase tracking-wider text-[#a3e635] hover:text-[#FFC700] transition-colors"
              >
            ...
            {/* Email Form input & button matching Image 1 SS */}
            <form onSubmit={handleSubmit} className="pt-2 space-y-3 max-w-lg">
              <div className="flex flex-col sm:flex-row items-stretch gap-2.5">
                <input
                  ...
                  required
                  className="flex-1 px-4 py-3.5 rounded-xl bg-[var(--surface)] border-2 border-black text-xs font-bold text-[var(--text-primary)] placeholder:text-[var(--text-secondary)] focus:outline-none focus:border-[#a3e635] transition-colors shadow-sm"
                />
                <button
                  type="submit"
                  data-cursor="hover"
                  className="px-8 py-3.5 rounded-xl bg-[#a3e635] text-black font-black text-xs uppercase tracking-wider border-2 border-black shadow-[4px_4px_0px_#000] hover:bg-[#b2f244] hover:translate-x-[-1px] hover:translate-y-[-1px] active:translate-x-0 active:translate-y-0 transition-all shrink-0 flex items-center justify-center gap-2"
                >
                  {submitted ? (
                    <>
              ...
              <label className="flex items-start gap-2 cursor-pointer select-none">
                <input
                  ...
                  className="mt-0.5 rounded border-black text-[#a3e635] focus:ring-0 accent-[#a3e635]"
                />
          ...
          {/* ========================================================================= */}
          {/* RIGHT COLUMN: DARK TABLET / UI SHOWCASE FRAME (Image 1 SS)                */}
          {/* ========================================================================= */}
          <div className="lg:col-span-6 relative pt-4 lg:pt-0">
            ...
            <div className="relative rounded-2xl border-2 border-black bg-[var(--bg)] p-4 sm:p-6 shadow-hard overflow-hidden">
              ...
              <div className="flex items-center justify-between pb-4 mb-4 border-b border-[var(--border)]">
                ...
                <div className="flex items-center gap-3">
                  <span className="px-2.5 py-1 rounded-full bg-[#18181B] text-[10px] font-bold text-[#a3e635] border border-black">
                    ● System Active
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-12 gap-4">
                ...
                <div className="sm:col-span-5 p-4 rounded-xl bg-gradient-to-br from-[#18181B] to-[#090A0C] border-2 border-black text-white flex flex-col justify-between h-44 shadow-md relative overflow-hidden group">
                  <div className="absolute top-0 right-0 w-32 h-32 bg-[#a3e635]/20 rounded-full blur-2xl group-hover:scale-125 transition-transform" />
                  
                  <div className="flex items-center justify-between relative z-10">
                    <span className="text-xs font-black font-display tracking-widest text-[#a3e635]">
                      KODX PHYSICAL
                    </span>
                  ...
                  <div className="space-y-1 relative z-10">
                    ...
                    <div className="flex justify-between items-end">
                      ...
                      <span className="text-xs font-extrabold italic text-[#a3e635]">VISA</span>
                    </div>
                  </div>
                </div>

                {/* Card Usage Stats */}
                <div className="sm:col-span-7 p-4 rounded-xl bg-[var(--surface)] border border-[var(--border)] flex flex-col justify-between">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-xs font-bold text-[var(--text-primary)]">Current Month Spend</span>
                    <span className="text-xs font-extrabold text-[#a3e635] font-display">$727.50 AUD</span>
                  </div>
                  ...
                  <div className="space-y-2 text-[11px]">
                    <div className="flex justify-between text-[var(--text-secondary)] font-medium">
                      ...
                      <span className="text-[#a3e635] font-bold">38.1%</span>
                    </div>
                    <div className="w-full bg-[var(--bg)] h-2 rounded-full overflow-hidden border border-black">
                      <div className="bg-[#a3e635] h-full w-[38.1%]" />
                    </div>
                    ...
                    <div className="flex justify-between text-[var(--text-secondary)] font-medium pt-1">
                      ...
                      <span className="text-[#FFC700] font-bold">61.5%</span>
                    </div>
                    <div className="w-full bg-[var(--bg)] h-2 rounded-full overflow-hidden border border-black">
                      <div className="bg-[#FFC700] h-full w-[61.5%]" />
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-4 p-3 rounded-xl bg-[var(--surface)] border border-[var(--border)] space-y-2">
                ...
                <div className="flex items-center justify-between text-xs py-1 border-b border-[var(--border)]">
                  <div className="flex items-center gap-2">
                    <div className="w-6 h-6 rounded bg-[#a3e635]/20 text-[#a3e635] flex items-center justify-center font-bold text-[10px]">
                      S
                    </div>
            ...
            {/* Floating Cookie / Notification Toast Overlay (Matching Image 1 SS) */}
            <div className="absolute bottom-[-15px] right-[-10px] sm:right-[-20px] max-w-xs p-4 rounded-2xl bg-[#18181B] border-2 border-black shadow-hard-lg z-20 space-y-2 text-white animate-bounce-subtle">
              <div className="flex items-start gap-2.5">
                <div className="p-1.5 rounded-lg bg-[#a3e635] text-black shrink-0 mt-0.5">
              ...
              <div className="pt-1 flex justify-end">
                <span className="px-3 py-1 rounded-lg bg-[#a3e635] text-black text-[10px] font-black uppercase border border-black shadow-[2px_2px_0px_#000]">
                  APPROVED (2M AGO)
                </span>
              </div>
            </div>
