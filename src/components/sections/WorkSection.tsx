    ...
    <section id="work" className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-16">
      ...
      <div className="rounded-3xl border-2 border-black bg-[#0B0C0E] text-white p-6 sm:p-10 shadow-hard-lg relative overflow-hidden font-sans">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 pb-6 mb-8 border-b border-white/10 text-xs font-mono font-bold tracking-wider text-gray-400">
          <div className="flex items-center gap-3">
            <span className="text-[#a3e635] uppercase">← SELECTED WORK</span>
        ...
        {/* Main Content Layout (Left Column: Case Study Title & CTA / Right Column: Dossier Card) */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start mb-12">
          
          {/* Left Column (8 cols) */}
          <div className="lg:col-span-8 space-y-6">
            <div className="text-xs font-black tracking-widest text-[#a3e635] uppercase font-mono">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-4">
              <Link
                ...
                data-cursor="hover"
                className="px-6 py-3.5 rounded-xl bg-[#a3e635] text-black font-black text-xs uppercase tracking-wider border border-black shadow-[3px_3px_0px_#000] hover:bg-[#b5f540] hover:translate-x-[-1px] hover:translate-y-[-1px] transition-all flex items-center gap-2"
              >
          ...
          {/* Right Column: Project Dossier Card (Screenshot 4) */}
        ...
        {/* Bottom 4 Metric Cards Grid with Glow Accent Lines (Screenshot 4) */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="rounded-2xl bg-[#141518] border border-white/10 p-5 flex flex-col justify-between space-y-4">
            ...
            <div className="w-full h-1 bg-white/10 rounded-full overflow-hidden">
              <div className="h-full w-[85%] bg-[#a3e635]" />
            </div>
          </div>
          ...
          <div className="rounded-2xl bg-[#141518] border border-white/10 p-5 flex flex-col justify-between space-y-4">
            ...
            <div className="w-full h-1 bg-white/10 rounded-full overflow-hidden">
              <div className="h-full w-[95%] bg-[#FFC700]" />
            </div>
          </div>
          ...
          <div className="rounded-2xl bg-[#141518] border border-white/10 p-5 flex flex-col justify-between space-y-4">
            ...
            <div className="w-full h-1 bg-white/10 rounded-full overflow-hidden">
              <div className="h-full w-[90%] bg-[#a3e635]" />
            </div>
          </div>
          ...
          <div className="rounded-2xl bg-[#141518] border border-white/10 p-5 flex flex-col justify-between space-y-4">
            ...
            <div className="w-full h-1 bg-white/10 rounded-full overflow-hidden">
              <div className="h-full w-full bg-[#a3e635]" />
            </div>
          </div>
      ...
      <div className="space-y-6">
        <h3 className="text-xl sm:text-2xl font-black font-display text-[var(--text-primary)] uppercase tracking-wide">
          More Selected Projects<span className="text-[#a3e635]">.</span>
        </h3>
            ...
            >
              ...
              <div className="relative h-64 sm:h-72 w-full overflow-hidden bg-[var(--bg)]">
                ...
                <div className="absolute top-4 left-4 flex gap-2">
                  ...
                  <span className="px-3 py-1 rounded-full bg-[#a3e635] text-xs font-black text-black border border-black">
                    {project.year}
                  </span>
                </div>
              </div>
              ...
              <div className="p-6 sm:p-8">
                ...
                <h4 className="text-2xl font-black font-display text-[var(--text-primary)] mb-3 group-hover:text-[#a3e635] transition-colors">
                  {project.title}
                </h4>
