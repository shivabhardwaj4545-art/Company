      ...
      <div className="relative w-full max-w-3xl bg-[#141518] border border-[#222429] rounded-2xl p-6 shadow-2xl text-white max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="mt-5 space-y-4 font-sans">
          ...
          <div className="pt-3 border-t border-[#222429]">
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                ...
                className="px-2.5 py-1 text-xs font-bold bg-[#857df3]/20 text-[#9d97f0] hover:bg-[#857df3] hover:text-white rounded border border-[#857df3]/40 transition-all"
              >
                + Add Custom Field
              </button>
            </div>
          ...
          <div className="flex items-center justify-end gap-3 pt-4 border-t border-[#222429]">
            ...
            <button
              type="submit"
              className="px-5 py-2 text-xs font-extrabold rounded-lg bg-[#857df3] text-white hover:bg-[#7269e8] transition-all shadow-[0_0_15px_rgba(133,125,243,0.3)]"
            >
              Save Changes
            </button>
          </div>
