    ...
    <header className="w-full bg-[#141518]/90 backdrop-blur-md border-b border-[#222429] px-6 py-4 flex flex-col md:flex-row items-center justify-between gap-4 sticky top-0 z-40 font-sans">
      ...
      <div className="relative w-full md:w-96">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2.5 bg-[#0B0C0E] border border-[#222429] rounded-xl text-xs font-semibold text-white placeholder-gray-500 focus:border-[#a3e635] focus:outline-none transition-all"
        />
      </div>
      ...
      <div className="flex items-center gap-4 w-full md:w-auto justify-between md:justify-end">
        ...
        <button
          ...
          className="px-5 py-2.5 rounded-xl bg-[#a3e635] text-black font-extrabold text-xs hover:bg-[#8ee01d] transition-all shadow-[0_0_20px_rgba(163,230,53,0.3)] flex items-center gap-2"
        >
