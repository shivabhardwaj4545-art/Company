...
export const initialProjects: ClientProject[] = [
  {
    id: 'proj-ezrestero',
    name: 'EZRestro POS & Order Management',
    clientName: 'EZRestro Hospitality Group',
  ...
  {
    id: 'proj-msg',
    name: 'MSG Ladies Suits & Sarees E-Commerce',
    clientName: 'MSG Ethnic Fashion House',
    ...
    notes: 'D2C E-Commerce storefront for ladies suits, silk sarees, and custom stitching options with WhatsApp checkout.',
    customFields: [
