...
export const initialProjects: ClientProject[] = [
  {
    id: 'proj-ezrestero',
    name: 'EzRestero POS & Order Management',
    clientName: 'EzRestero Hospitality Group',
    clientEmail: 'contact@ezrestero.com',
    serviceCategory: 'Web Development',
    status: 'Active',
    budget: '$32,000',
    liveUrl: 'https://ezrestero.com',
    domainName: 'ezrestero.com',
    hostingProvider: 'Hostinger VPS (KVM 2)',
    domainExpiryDate: '2027-08-15',
    hostingExpiryDate: '2027-08-15',
    notes: 'Smart restaurant POS, table QR ordering, and real-time kitchen workflow system.',
    customFields: [
  ...
  {
    id: 'proj-msg',
    name: 'MSG Unified Messaging Portal',
    clientName: 'MSG Enterprise Systems',
    clientEmail: 'support@msg.io',
    serviceCategory: 'AI Automation',
    status: 'Active',
    budget: '$42,500',
    liveUrl: 'https://msg.io',
    domainName: 'msg.io',
    hostingProvider: 'Hostinger VPS (KVM 2)',
    domainExpiryDate: '2027-09-10',
    hostingExpiryDate: '2027-09-10',
    notes: 'Unified communication inbox & broadcast API engine for WhatsApp, SMS, and Email.',
    customFields: [
      { id: 'cf-msg-1', key: 'WhatsApp API', value: 'Cloud API v18.0 Connected' },
    ],
    createdAt: '2026-03-01',
  },
  {
    id: 'proj-dropizi',
    name: 'Dropizi Courier & Logistics (Future Works)',
    clientName: 'Dropizi Express Global',
    clientEmail: 'dev@dropizi.com',
    serviceCategory: 'Full Digital Package',
    status: 'In Development',
    budget: '$55,000',
    liveUrl: 'https://dropizi.com',
    domainName: 'dropizi.com',
    hostingProvider: 'Hostinger VPS (KVM 2)',
    domainExpiryDate: '2027-11-20',
    hostingExpiryDate: '2027-11-20',
    notes: 'Upcoming parcel dispatching platform, driver routes, and live GPS delivery tracking.',
    customFields: [
      { id: 'cf-drp-1', key: 'Pipeline Status', value: 'Future Works / In Production' },
    ],
